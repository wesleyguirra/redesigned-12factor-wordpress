...
define('AWS_ACCESS_KEY_ID', getenv('AWS_ACCESS_KEY_ID')?:getenv('CLOUDCUBE_ACCESS_KEY_ID'));
define('AWS_SECRET_ACCESS_KEY', getenv('AWS_SECRET_ACCESS_KEY')?:getenv('CLOUDCUBE_SECRET_ACCESS_KEY'));
define('AS3CF_BUCKET', getenv('S3_BUCKET')?:'cloud-cube');
